...
<head>
    ...
    <style>
        ...
        input[type="text"]:focus, input[type="email"]:focus, input[type="date"], input[type="number"]:focus {
            outline: none;
            border-color: #0056b3;
            ...
            <form action="register" method="post">
                <div class="tab-content bg-white" id="myTabContent">
                    <div class="tab-pane shadow p-5 fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                        ...
                        <div class="form-group my-4">
                            <input type="number" name="oraInizio" placeholder="Ora di inizio lavoro" required><br>
                        </div>
                        <div class="form-group my-4">
                            <input type="number" name="oraFine" placeholder="Ora di fine lavoro" required><br>
                        </div>
                        <div class="form-group my-4">
                            <input type="text" name="luogoDiLavoro" placeholder="Luogo Di Lavoro" required><br>
                        </div>
                        <div class="mb-4">
                            <button class="btn btn-primary btn-block rounded " type="submit" id="invio" name="invio">Invio</button>
                        </div>
                    </div>
                </div>
            </form>
